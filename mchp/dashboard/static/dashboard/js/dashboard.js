$(function(){
	...
	*/
	...
	var btmHeight = $(window).height() - 0;

	$('.pulse-con').css('max-height', btmHeight);
	$('#news-scroll').css('max-height', btmHeight);

	$('#news-scroll > ul.news-group.list-group.visible-group:last').css('margin-bottom','0');
