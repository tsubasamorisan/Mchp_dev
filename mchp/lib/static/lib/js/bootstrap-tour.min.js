...
// CRAZY COOL SCRIPT THAT ACTUALLY MAKES BACKDROP WORK AWESOMELY

//insane script that I found that seems to make the backdrop work correctly
	Tour.prototype._showOverlayElement = function(element) {
		...
		$clone.width($element.innerWidth()).height($element.innerHeight()).addClass("tour-step-background tour-clone-element").offset(offset);
		  // $element.addClass("tour-step-backdrop");

		  $("body").append($background).append($clone);
