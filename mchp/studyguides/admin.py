...
class StudyGuideCampaignAdmin(admin.ModelAdmin):
    list_display = ('event', 'template', 'active', 'when', 'until')
    fieldsets = (
        (None, {
            'fields': ['event', 'documents', 'subject', 'template',
    ...
    # everything is readonly since this campaign is autogenerated
    readonly_fields = ('event', 'documents', 'subject', 'template',
                       'sender_name', 'sender_address', 'when', 'until')
